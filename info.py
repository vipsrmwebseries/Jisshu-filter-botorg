...
USERNAME = environ.get("USERNAME", "Rk2xBots")  # ADMIN USERNAME
...
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1003211425666"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1002986618311"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002932289001"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1002932289001"))
...
# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1003091186065"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "0"))
request_channel = environ.get("REQUEST_CHANNEL", "-1003091186065")
REQUEST_CHANNEL = (
    int(request_channel)
    if request_channel and id_pattern.search(request_channel)
    else None
)
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1002363286486"))

# Added Link Here Not Id
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "")
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/Rk2x_Request")
...
DELETE_TIME = int(environ.get("DELETE_TIME", 450))
...
TMDB_API_KEY = environ.get("TMDB_API_KEY", "8ea253c57a45285f5fd2b85ca425a819")
